    ...
    >
      <div className="flex flex-col items-center">
        <motion.h2
          ...
          className="text-[var(--color-detail)] font-medium text-[1.4vh] font-mono"
        >
          PORTFOLIO / 2025
        </motion.h2>
        ...
        <motion.ul
          variants={itemVariants}
          className="flex gap-4 text-[var(--color-text)]"
        >
          {focus.map((f) => (
            <motion.li
              key={f.id}
      ...
      <motion.div
        variants={itemVariants}
        className="flex flex-col items-center text-[1.4vh]"
      >
