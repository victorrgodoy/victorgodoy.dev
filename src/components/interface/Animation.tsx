import { animate, useMotionValue, useTransform, useMotionTemplate, motion, MotionValue } from "motion/react";
...
function Animation({setShowAnimation}:Props) {
  ...
  useEffect(() => {
    const controls = animate(count, 100, { duration: 2.5, onComplete: () => {
